...
export const Input: React.FC<{
  ...
  return (
    <input
      className="leading-[1.7] block w-full rounded-geist bg-white p-geist-half text-black text-sm border border-gray-300 transition-colors duration-150 ease-in-out focus:border-focused-border-color outline-none"
      disabled={disabled}
      name="title"
